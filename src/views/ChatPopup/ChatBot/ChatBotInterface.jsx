...
//Image
import logo from '../../../assets/img/mylogowhite.png';
...
const ChatBotInterface = ({ show, sendMsg, msg }) => {
    ...
    return (
        <>
            <div className={classNames("hk-chatbot-popup", { "d-md-block d-flex": showChatbot })}>
                ...
                <footer>
                    <div className={classNames("chatbot-intro-text fs-7", { "d-none": startConversation })}>
                        ...
                        <p className="mb-2">This is onepixelsoft&apos;s beta version please sign up now to get early access to our full version</p>
            ...
            <div className={classNames("chat-popover shadow-xl", { "d-flex": showPopup })}><p>Try Onepixel Soft Chat for free and connect with your customers now!</p></div>
        </>
    )
}
