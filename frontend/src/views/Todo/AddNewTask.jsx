                        ...
                        <div data-repeater-list="category-group">
                            <div className="d-flex">
                                ...
                                <HkTooltip placement="top" title="Add Person" >
                                    <Link to="#" className="btn btn-xs btn-icon btn-rounded btn-outline-primary mb-2">
                                        <span className="icon">
                            ...
                            <div className="d-flex">
                                ...
                                <Link to="#" className="btn btn-xs btn-icon btn-rounded btn-outline-danger ms-2 mt-1">
                                    <span className="icon">
