                    ...
                    <div className="d-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                />
                                <span className="todo-text text-truncate" onClick={props.taskInfo} >
                                    {/* onClick={showInfo} */}
                                    {props.task.title}
                                </span>
                                {
                        ...
                        <div className="d-flex flex-shrink-0 align-items-center ms-3">
                            {
                                props.task.task_time && props.task.task_time.map((ele, i) => (
                                    <span className={
                            ...
                            <Dropdown>
                                ...
                                <Dropdown.Menu align="end" >
                                    <Dropdown.Item className="edit-task" onClick={props.taskInfo}>Edit Task</Dropdown.Item>
                                    <Dropdown.Item className="view-task" onClick={props.taskInfo}>View Task</Dropdown.Item>
                                    <Dropdown.Item className="delete-task" onClick={() => props.onRemoveTask(props.task._id || props.task.id, props.cardId)} >Delete Task</Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>
                        </div>
                    </div>
